...
class UserOrgMembership(Base):
    ...
    # Lifecycle: self-claims land 'pending'; admin/invite grants and
    # approvals are 'active'; Team & Access removal sets 'removed' (soft,
    # stamped, restorable — never deleted). Every membership read that
    # implies trust (org_memberships, directory, resolve boost) filters to
    # active.
